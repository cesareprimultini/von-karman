...
def plot_strain_n_curve(df, graphs_dir='graphs'):
    ...
    strain values from the beam model overlaid.
    """
    ...
    ax.set_title(r'$\epsilon$-N Fatigue Curve with Beam Model Results', fontsize=14)
    ax.set_xlim(1, 1e9)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(graphs_dir, 'strain_n_curve_beam.png'), dpi=150)
    plt.close()
...
if __name__ == "__main__":
    ...
    print("Saved: strain_n_curve_beam.png")
